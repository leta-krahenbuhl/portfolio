...
export default function DesktopTextBox() {
  return (
    <article className="about__container">
      <main className="about__main">
        ...
        <p className="about__text">Do get in touch or check out my socials!</p>
        ...
        <a className="about__text-link" href="mailto:leta.krahenbuhl@gmail.com">
          &#x1F4E7; Send me an email
        </a>
      </main>

      <div className="about__navigation"></div>
    </article>
  );
}
