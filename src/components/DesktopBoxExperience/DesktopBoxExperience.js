      ...
      <article className="desktop-text-box-new">
        <main className="desktop-text-box-new__main">
          ...
          <section className="desktop-text-box-new__section">
            ...
            <ul className="desktop-text-box-new__list">
              <li className="desktop-text-box-new__list-item">
                Built excellent communication skills by liaising with and
                between prisoners, prison officers, prison agencies, probation,
                police, social services, community services, GPs and prisoner's
                families
              </li>
              <li className="desktop-text-box-new__list-item">
              ...
              <li className="desktop-text-box-new__list-item">
                Developed superb organisation skills by carrying a caseload of
                up to 50 service users at once
              </li>
            </ul>
          </section>
          ...
          <section className="desktop-text-box-new__section">
            ...
            <ul className="desktop-text-box-new__list">
              <li className="desktop-text-box-new__list-item">
                Worked on a broad range of digital (newsletters, app
                development, websites) as well as print (books, tabloids,
                branding) projects for a variety of clients including luxury
                jewelers, personal clients and charities
              </li>
              <li className="desktop-text-box-new__list-item">
